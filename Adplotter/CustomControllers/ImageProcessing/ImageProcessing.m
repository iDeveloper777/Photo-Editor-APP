...
//  YAMOOD
//
//  Created by Ireneo Decano on 4/2/15.
...
- (void) saveImageToAlbum:(UIImage *)image
{
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Alert!" message:@"Your image saved successfully. Please check your album." delegate:nil cancelButtonTitle:@"O K" otherButtonTitles:nil, nil];
    [alertView show];
}
@end
