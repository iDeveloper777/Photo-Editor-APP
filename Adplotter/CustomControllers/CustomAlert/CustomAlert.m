...
//            TitleLbl.minimumFontSize = 12.0;
        ...
        if (cancelButtonTitle && ![otherButtonTitle isEqualToString:@""])
        {
        ...
        else if (cancelButtonTitle && [otherButtonTitle isEqualToString:@""])
        {
            CancelBtn = [[UIButton alloc] initWithFrame:CGRectMake((int)((alert_width-CancelBtnImg.size.width * 1.5)/2.0), alert_height, CancelBtnImg.size.width * 1.5, CancelBtnImg.size.height)];
            [CancelBtn setTag:1000];
            [CancelBtn setTitle:cancelButtonTitle forState:UIControlStateNormal];
            [CancelBtn.titleLabel setFont:[UIFont boldSystemFontOfSize:18.0]];
            [CancelBtn setBackgroundImage:CancelBtnImg forState:UIControlStateNormal];
        ...
        else if ([otherButtonTitle isEqualToString:@""])
        {
